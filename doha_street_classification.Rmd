...
Overall, it is noticeable that around the stadium an intesivisation and densification of streets can be seen. 

# Discussion/Conclusion
Comparing the different years, it is noticeable that some roads were classified as a change between road to no road. With more time it would be interesting to find out whether this classification is due to the selected satellite image and given inaccuracies, whether there is an error in the algorithm, or whether it is an actual ablation of the road. 
# Lessons Learned
